...
export const MDXComponents = {
  VideoPlayer,
  AudioPlayer,
  h1: (props: MDXHeadingProps) => <h1 className="text-4xl font-bold mt-12 mb-6 text-gray-900 dark:text-gray-100 scroll-mt-40" style={{ scrollMarginTop: '120px' }} {...props} />,
  h2: (props: MDXHeadingProps) => <h2 className="text-3xl font-bold mt-10 mb-4 text-gray-900 dark:text-gray-100 border-b border-gray-300 dark:border-gray-800 pb-2 scroll-mt-40" style={{ scrollMarginTop: '120px' }} {...props} />,
  h3: (props: MDXHeadingProps) => <h3 className="text-2xl font-semibold mt-8 mb-3 text-gray-900 dark:text-gray-100 scroll-mt-40" style={{ scrollMarginTop: '120px' }} {...props} />,
  h4: (props: MDXHeadingProps) => <h4 className="text-xl font-semibold mt-6 mb-2 text-gray-900 dark:text-gray-100 scroll-mt-40" style={{ scrollMarginTop: '120px' }} {...props} />,
